...
insert into  gal_orc_v2temp partition(date_part) select * from gal_src_v2 where url!='' and date_part!="__HIVE_DEFAULT_PARTITION__";
...
insert into table index_hbase_v2 select mask_hash(url),date_part,url  from gal_orc_v2temp;
