...
public class MyBatisPlusConfig {
    ...
    public MapperScannerConfigurer mapperScannerConfigurer() {
        ...
        mapperScannerConfigurer.setBasePackage("com.yuchen.data.service.mapper");
        return mapperScannerConfigurer;
    }


    @Bean("sqlSessionFactory")
    public MybatisSqlSessionFactoryBean mybatisSqlSessionFactoryBean(MybatisConfiguration mybatisConfiguration, GlobalConfig globalConfig, DataSource dataSource) throws IOException {
    ...
    public Interceptor[] interceptors() {
        ...
        properties.setProperty("page:dbType", DbType.MYSQL.name());
