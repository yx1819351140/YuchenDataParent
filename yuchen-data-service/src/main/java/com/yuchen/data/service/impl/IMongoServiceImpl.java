 ...
 * @Package: com.yuchen.data.service.impl
 * @ClassName: IMongoServiceImpl
 * @Description: Mongo服务实现
 **/
@DubboService(version = "1.0.0")
public class IMongoServiceImpl implements IMongoService {

    private static final Logger logger = LoggerFactory.getLogger(IMongoServiceImpl.class);
    @Override
